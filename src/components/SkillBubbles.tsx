...
const SkillBubbles = ({
  ...
  const BubbleComponent = memo(({ skill, index }: { skill: Skill; index: number }) => {
      ...
      <Tooltip key={skill.id}>
        <TooltipTrigger asChild>
            <motion.div
              ...
              transition={{
                delay: isVisible && !animationComplete ? index * 0.1 : 0,
                duration: 0.6,
                type: "spring",
                stiffness: 120,
                damping: 18,
...
export default memo(SkillBubbles);